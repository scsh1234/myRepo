...
// document.querySelector("img").setAttribute("src",mystring);
...
{
    document.getElementById("h32").innerHTML="PLAYER 1 WINS !";
}
else if(randomNumber2>randomNumber1)
{
    document.getElementById("h32").innerHTML="PLAYER 2 WINS !"
}
else
{
    document.getElementById("h32").innerHTML="DRAW";
}